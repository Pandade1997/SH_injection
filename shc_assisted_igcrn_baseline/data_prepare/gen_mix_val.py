...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--clean_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/data_txt/val_clean_list.txt',
    ...
    parser.add_argument(
        '--rir_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/loader_txt_cir_uniform_9//val_rir.txt',
    ...
    parser.add_argument(
        '--mix_config_path',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/generated_data_cir_uniform_9_random/val/mix_val.config',
    ...
    parser.add_argument(
        '--save_dir',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/generated_data_cir_uniform_9_random/val',
    ...
    txt_path = os.path.join(
        '/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/generated_data_cir_uniform_9_random/val/wav_scp_val.txt')
