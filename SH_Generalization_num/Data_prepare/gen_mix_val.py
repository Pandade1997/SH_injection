...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--clean_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/loader_txt/wav_list/val_clean_list.txt',
    ...
    parser.add_argument(
        '--noise_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/loader_txt/wav_list/val_noise_list.txt',
    ...
    parser.add_argument(
        '--mix_config_path',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/generated_data/val/mix_val.config',
    ...
    parser.add_argument(
        '--save_dir',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/generated_data/val',
    ...
    txt_path = os.path.join(
        '/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/loader_txt/wav_scp/wav_scp_val.txt')
