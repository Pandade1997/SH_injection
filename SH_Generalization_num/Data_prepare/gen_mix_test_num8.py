...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--clean_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/loader_txt/wav_list/test_clean_list.txt',
    ...
    parser.add_argument(
        '--noise_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/loader_txt/wav_list/test_noise_list.txt',
    ...
    parser.add_argument(
        '--rir_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/loader_txt/rir/rir_test_mic_' + str(
            channels) + '.txt',
    ...
    parser.add_argument(
        '--mix_config_path',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/generated_data/test_mic_' + str(
            channels) + '/mix_' + str(channels) + '.config',
    ...
    txt_path = os.path.join(
        '/ddnstor/imu_panjiahui/dataset/SHGeneralization/cir_random_num_TVT/multi_channel/Mic8_2s_gpurir/loader_txt/wav_scp/wav_scp_test_mic_' + str(
            channels) + '.txt')
