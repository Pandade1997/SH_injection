...
def wav_generator(mix_path, ref_path, mic_path):
    ...
    with torch.no_grad():
        outputs = load_network(shc_input.transpose(1, 2), ilens, stft_input.transpose(1, 2))
    outputs = outputs[0][0]
...
if __name__ == "__main__":
    ...
    for test_name in test_list:
        ...
        load_network = TFGridNetV2(input_dim=None, n_srcs=1, n_fft=512, stride=256, n_shc=25, n_stft=1, n_layers=3,
