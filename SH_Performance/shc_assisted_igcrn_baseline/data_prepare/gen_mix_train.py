...
def get_mix_config(clean_chunk_path, noise_path, rir_path, config_path, snr_range=[-6, 6], scale_range=[2, 9]):
    '''
    ...
    for line in clean_lines:
        ...
        scale = np.random.uniform(*scale_range) / 10  # scale range is [0.2, 0.9)
        # print(snr)
        # print(scale)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--clean_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/data_txt/train_clean_list.txt',
        help='the list of clean wav to read'
    )
    # train_clean_list.txt复制到8W
    parser.add_argument(
        '--noise_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/data_txt/train_val_noise_list.txt',
    ...
    parser.add_argument(
        '--rir_wav_list',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/loader_txt_cir_uniform_9/train_rir.txt',
    ...
    parser.add_argument(
        '--mix_config_path',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/generated_data_cir_uniform_9_random/train/mix_train.config',
    ...
    parser.add_argument(
        '--save_dir',
        type=str,
        default='/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/generated_data_cir_uniform_9_random/train',
    ...
    txt_path = os.path.join(
        '/ddnstor/imu_panjiahui/dataset/SHdomainShcAssisted/generated_data_cir_uniform_9_random/train/wav_scp_train.txt')
